    ...
    <div class="acs-footer">
        <div class="acs-footer-links">        
            <ul>
                ...
                <li><a href="<?php echo esc_url( add_query_arg(array('page' => ACS_SLUG, 'system-info' => true,), admin_url('admin.php')) ); ?>"><?php echo __( 'Report a problem', 'arvancloud-object-storage' ) ?></a></li>
            </ul>
        </div>
        <div class="acs-footer-social">
            <div class="footer__social-icons">
                <?php 
                if ( get_locale() == 'fa_IR' ) {
                    echo '<a class="footer__social-icons__link footer__social-icons--telegram" href="https://t.me/arvancloud" target="_blank" rel="noopener noreferrer">
                ...
                <a class="footer__social-icons__link footer__social-icons--linkedin" href="<?php echo get_locale() == 'fa_IR' ? 'https://www.linkedin.com/company/arvancloud-fa' : 'https://www.linkedin.com/company/arvancloud' ?>" target="_blank" rel="noopener noreferrer">
                ...
                <a class="footer__social-icons__link footer__social-icons--twitter" href="<?php echo get_locale() == 'fa_IR' ? 'https://twitter.com/ArvanCloud_fa' : 'https://twitter.com/ArvanCloud' ?>" target="_blank" rel="noopener noreferrer">
                ...
                <a class="footer__social-icons__link footer__social-icons--instagram" href="<?php echo get_locale() == 'fa_IR' ? 'https://instagram.com/arvancloud_fa' : 'https://www.instagram.com/arvancloud' ?>" target="_blank" rel="noopener noreferrer">
